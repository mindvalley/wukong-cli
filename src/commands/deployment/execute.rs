...
<!-- The changelogs above is generated by Wukong. You can edit the changelogs here if you want. -->
<!-- The changelogs is in markdown format. -->
<!-- Save the changelogs (:wq if you are using vim) to go to the next deployment step. -->

<!-- Lines in between '<!--' and '-->' will be ignored in the final changelogs. -->
"#;
            changelogs = format!("{}\n{}", changelogs, instructions);
        }
