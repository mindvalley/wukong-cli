...
complete -c wukong -n "__fish_use_subcommand" -f -a "google" -d 'This command group contains the commands to interact with Google services'
...
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -l report -d 'Store the debugging log in the log file, which is located at ~/.config/wukong'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -l canary -d 'Use the Canary channel API'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "info" -d 'Show the application’s relevant informations'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "logs" -d 'Getting the logs of the applications from the Google Cloud Logging'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "instances" -d 'This command group contains the commands to interact with an application’s instances'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "init"
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from init" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from init" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from init" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from init" -l report -d 'Store the debugging log in the log file, which is located at ~/.config/wukong'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from init" -l canary -d 'Use the Canary channel API'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from init" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "info" -d 'Show the application’s relevant informations'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "logs" -d 'Getting the logs of the applications from the Google Cloud Logging'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "instances" -d 'This command group contains the commands to interact with an application’s instances'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "init"
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -l report -d 'Store the debugging log in the log file, which is located at ~/.config/wukong'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -l canary -d 'Use the Canary channel API'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "list" -d 'List the current available deployment pipelines of an application'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "execute" -d 'Start the deployment pipeline'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "rollback" -d 'Rollback the deployment pipeline'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "status" -d 'Get the status of the latest deployment'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from status" -l version -d 'The version of the deployment' -r -f -a "{blue	'',green	''}"
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from status" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from status" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from status" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from status" -l report -d 'Store the debugging log in the log file, which is located at ~/.config/wukong'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from status" -l canary -d 'Use the Canary channel API'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from status" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "list" -d 'List the current available deployment pipelines of an application'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "execute" -d 'Start the deployment pipeline'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "rollback" -d 'Rollback the deployment pipeline'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "status" -d 'Get the status of the latest deployment'
complete -c wukong -n "__fish_seen_subcommand_from deployment; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -l report -d 'Store the debugging log in the log file, which is located at ~/.config/wukong'
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -l canary -d 'Use the Canary channel API'
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -f -a "login" -d 'Login to Google'
complete -c wukong -n "__fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from login" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from login" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from login" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from login" -l report -d 'Store the debugging log in the log file, which is located at ~/.config/wukong'
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from login" -l canary -d 'Use the Canary channel API'
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from login" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -f -a "login" -d 'Login to Google'
complete -c wukong -n "__fish_seen_subcommand_from google; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "init" -d 'Initialize Wukong\'s configurations'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "application" -d 'This command group contains the commands to interact with an application’s configurations'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "pipeline" -d 'This command group contains the commands to view & interact with an application’s pipeline'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "deployment" -d 'This command group contains the commands to view and interact with the Continuous Delivery pipeline of an application'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "dev" -d 'This command group contains the commands to interact with the local development environment'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "config" -d 'This command group contains the commands to view & interact with Wukong\'s configurations'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "login" -d 'Login to start using wukong command'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "google" -d 'This command group contains the commands to interact with Google services'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "completion" -d 'Generate wukong cli completions for your shell to stdout'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "tui" -d 'Start TUI session'
complete -c wukong -n "__fish_seen_subcommand_from help; and not __fish_seen_subcommand_from init; and not __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from pipeline; and not __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from completion; and not __fish_seen_subcommand_from tui; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init" -f -a "info" -d 'Show the application’s relevant informations'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init" -f -a "logs" -d 'Getting the logs of the applications from the Google Cloud Logging'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init" -f -a "instances" -d 'This command group contains the commands to interact with an application’s instances'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from init" -f -a "init"
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from connect" -f -a "list" -d 'Listing the currently running Elixir instances, normally under a GKE Pod'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and __fish_seen_subcommand_from instances; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from connect" -f -a "connect" -d 'Start the interactive session to connect to the remote Elixir instance'
...
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status" -f -a "list" -d 'List the current available deployment pipelines of an application'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status" -f -a "execute" -d 'Start the deployment pipeline'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status" -f -a "rollback" -d 'Rollback the deployment pipeline'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from deployment; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from execute; and not __fish_seen_subcommand_from rollback; and not __fish_seen_subcommand_from status" -f -a "status" -d 'Get the status of the latest deployment'
...
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from google; and not __fish_seen_subcommand_from login" -f -a "login" -d 'Login to Google'
