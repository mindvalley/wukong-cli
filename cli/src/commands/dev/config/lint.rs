...
use crate::{error::WKCliError, loader::new_progress_bar};
use ignore::{overrides::OverrideBuilder, WalkBuilder};
use indicatif::ParallelProgressIterator;
use miette::GraphicalReportHandler;
use rayon::prelude::{IntoParallelRefIterator, ParallelExtend, ParallelIterator};
use wukong_sdk::linter::elixir::{LintRule, Linter};

pub fn handle_config_lint(path: &Path) -> Result<bool, WKCliError> {
