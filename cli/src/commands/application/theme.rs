...
/// A colorful theme
pub struct CustomColorfulTheme {
    ...
    /// The hint to show for certain prompts
    pub help_message: StyledObject<String> 
}

impl Default for CustomColorfulTheme {
    fn default() -> CustomColorfulTheme {
        CustomColorfulTheme {
            ...
            help_message: style("[Leave blank to generate a random name]".to_string()).for_stderr().color256(13).bold(),
        }
    }
}
