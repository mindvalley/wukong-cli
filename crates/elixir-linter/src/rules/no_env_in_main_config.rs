...
pub struct NoEnvInMainConfig {
    query: Query,
}

impl NoEnvInMainConfig {
...
impl Rule for NoEnvInMainConfig {
    fn name(&self) -> &'static str {
        "no_env_in_main_config"
    }
    ...
    fn explain(&self) -> &'static str {
        "Main config must not contains any environment variables"
    }

    fn advice(&self) -> &'static str {
        "Move this config value into either `runtime.exs` if you’re reading them during runtime, or providing a static value."
    }
