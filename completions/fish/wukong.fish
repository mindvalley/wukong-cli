...
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "info" -d 'Show the application’s relevant informations'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "logs-demo" -d 'Demo gcloud log'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "logs" -d 'Getting the logs of the applications from the Google Cloud Logging'
complete -c wukong -n "__fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from logs-demo" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from logs-demo" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from logs-demo" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from logs-demo" -s h -l help -d 'Print help'
...
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "info" -d 'Show the application’s relevant informations'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "logs-demo" -d 'Demo gcloud log'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "logs" -d 'Getting the logs of the applications from the Google Cloud Logging'
complete -c wukong -n "__fish_seen_subcommand_from application; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs" -f -a "info" -d 'Show the application’s relevant informations'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs" -f -a "logs-demo" -d 'Demo gcloud log'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from application; and not __fish_seen_subcommand_from info; and not __fish_seen_subcommand_from logs-demo; and not __fish_seen_subcommand_from logs" -f -a "logs" -d 'Getting the logs of the applications from the Google Cloud Logging'
