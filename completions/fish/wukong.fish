...
complete -c wukong -n "__fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -f -a "config-lint" -d 'Linting the config and show possible warnings, as well as suggestion how to fix the config file'
complete -c wukong -n "__fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -f -a "config" -d 'This command group contains the commands to interact with the config secrets with bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -s a -l application -d 'Override the application name that the CLI will perform the command against. If the flag is not used, then the CLI will use the default application name from the config' -r
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -s v -l verbose -d 'Use verbos output. More output per occurrence.
...
`-vvv` show debug
`-vvvv` show trace'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -s q -l quiet -d 'Do not print log message'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -s h -l help -d 'Print help'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "push" -d 'Push the current configuration changes to the Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "diff" -d 'Show changes between the local configuration and the Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "pull" -d 'Pull the development config with secrets file from Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "push" -d 'Push the current configuration changes to the Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "diff" -d 'Show changes between the local configuration and the Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "pull" -d 'Pull the development config with secrets file from Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from config; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -f -a "config-lint" -d 'Linting the config and show possible warnings, as well as suggestion how to fix the config file'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -f -a "config" -d 'This command group contains the commands to interact with the config secrets with bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from help; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from help; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull" -f -a "push" -d 'Push the current configuration changes to the Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from help; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull" -f -a "diff" -d 'Show changes between the local configuration and the Bunker'
complete -c wukong -n "__fish_seen_subcommand_from dev; and __fish_seen_subcommand_from help; and __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from push; and not __fish_seen_subcommand_from diff; and not __fish_seen_subcommand_from pull" -f -a "pull" -d 'Pull the development config with secrets file from Bunker'
...
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config" -f -a "config-lint" -d 'Linting the config and show possible warnings, as well as suggestion how to fix the config file'
complete -c wukong -n "__fish_seen_subcommand_from help; and __fish_seen_subcommand_from dev; and not __fish_seen_subcommand_from config-lint; and not __fish_seen_subcommand_from config" -f -a "config" -d 'This command group contains the commands to interact with the config secrets with bunker'
